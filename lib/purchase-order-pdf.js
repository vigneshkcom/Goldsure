...
async function renderDocument(po, { title, recipientLabel, amountLabel, finalLabel, showReference, includeInvoiceNote }) {
  ...
  // Jobs table.
  const columns = tableColumns(amountLabel, contentWidth);
  ...
  drawRow(doc, columns, left, y, rowHeight + 2, [
    'Total',
    '',
