  ...
  <table role="presentation" width="560" border="0" cellpadding="0" cellspacing="0" style="max-width:560px;">
    ...
    <tr><td style="background:#ffffff;padding:28px 28px 32px;border-radius:0 0 6px 6px;border:1px solid #e3e7ef;border-top:none;">
      ...
      <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom:22px;border:1px solid #e3e7ef;border-radius:4px;">
        ...
        <tr><td style="padding:10px 14px;border-bottom:1px solid #e3e7ef;font-size:13px;color:#3d4658;">Upfront payment</td><td align="right" style="padding:10px 14px;border-bottom:1px solid #e3e7ef;font-size:13px;font-weight:700;color:#b08d2e;">${money(q.deposit_amount ?? 220)}</td></tr>
        ...
        ${Number(q.no_finance_discount) > 0 ? `<tr><td style="padding:10px 14px;border-bottom:1px solid #e3e7ef;font-size:13px;color:#3d4658;">Discount</td><td align="right" style="padding:10px 14px;border-bottom:1px solid #e3e7ef;font-size:13px;font-weight:600;color:#18a96e;">− ${money(q.no_finance_discount)}</td></tr>` : ''}
