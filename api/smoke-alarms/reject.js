...
<head>
  ...
  <title>Quote Declined – Goldsure</title>
</head>
        ...
        <tr>
          <td style="background:#ffffff;padding:28px 28px 32px;border-radius:0 0 4px 4px;border:1px solid #e3e7ef;border-top:none;">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
              <tr>
                <td>
                  <p style="margin:0 0 4px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#e04f4f;">Quote Declined</p>
                  <p style="margin:0;font-size:22px;font-weight:700;color:#141c2e;line-height:1.2;">${customer_name}</p>
                </td>
                <td align="right" valign="top">
                  <p style="margin:0;font-size:11px;color:#6b7899;">${rejected_at || ''}</p>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom:24px;border:1px solid #e3e7ef;border-radius:4px;">
              ...
              <tr>
                <td style="padding:10px 14px;background:#f0f2f5;">
                  <p style="margin:0;font-size:11px;color:#6b7899;">Quote Total</p>
                </td>
                <td style="padding:10px 14px;">
                  <p style="margin:0;font-size:13px;font-weight:600;color:#141c2e;">${grand_total || '—'}</p>
                </td>
              </tr>
            </table>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding:12px 16px;background:#fdecec;border-left:3px solid #e04f4f;border-radius:0 4px 4px 0;">
                  <p style="margin:0;font-size:13px;color:#a03636;line-height:1.6;">
                    <strong style="color:#141c2e;">Heads up:</strong> ${customer_name} declined this quote online. No further reminders will be sent.
                  </p>
                </td>
              </tr>
            </table>
  ...
  try {
    const response = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        subject: `Quote Declined – ${customer_name}`,
        html,
      }),
    });
