...
export default async function handler(req, res) {
  ...
  if (body.time !== undefined) {
    ...
    let rates = { David: 13.54, Shanira: 32, 'Alda Amonaki': 10.4175 };
